  ...
  return (
    <div className="flex flex-col gap-16 px-6 pb-24 pt-6 min-[880px]:gap-24 min-[880px]:px-12 min-[880px]:pt-10">
      ...
      <Caveat reduce={reduce}>
        Press coverage on this page is real. Supporter voices are placeholders until we
        collect more. Social channels aren&rsquo;t live yet. The page will fill out as the
        movement does &mdash; slowly, honestly, on the record.
      </Caveat>
